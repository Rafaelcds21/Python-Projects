...
def dia_1(event):
    texto_resposta_1 = Label(janela, text=f"dia: {conteudo['results']['forecast'][1]['date']}/2022\n"
                                          ...
                                          f"temp_max: {conteudo['results']['forecast'][1]['min']}°C\n"
                                          f"temp_min: {conteudo['results']['forecast'][1]['max']}°C\n"
...
def dia_2(event):
    texto_resposta_1 = Label(janela, text=f"dia: {conteudo['results']['forecast'][2]['date']}/2022\n"
                                          ...
                                          f"temp_max: {conteudo['results']['forecast'][2]['min']}°C\n"
                                          f"temp_min: {conteudo['results']['forecast'][2]['max']}°C\n"
...
def dia_3(event):
    texto_resposta_1 = Label(janela, text=f"dia: {conteudo['results']['forecast'][3]['date']}/2022\n"
                                          ...
                                          f"temp_max: {conteudo['results']['forecast'][3]['min']}°C\n"
                                          f"temp_min: {conteudo['results']['forecast'][3]['max']}°C\n"
...
def dia_4(event):
    texto_resposta_1 = Label(janela, text=f"dia: {conteudo['results']['forecast'][4]['date']}/2022\n"
                                          ...
                                          f"temp_max: {conteudo['results']['forecast'][4]['min']}°C\n"
                                          f"temp_min: {conteudo['results']['forecast'][4]['max']}°C\n"
...
def dia_5(event):
    texto_resposta_1 = Label(janela, text=f"dia: {conteudo['results']['forecast'][5]['date']}/2022\n"
                                          ...
                                          f"temp_max: {conteudo['results']['forecast'][5]['min']}°C\n"
                                          f"temp_min: {conteudo['results']['forecast'][5]['max']}°C\n"
...
def dia_6(event):
    texto_resposta_1 = Label(janela, text=f"dia: {conteudo['results']['forecast'][6]['date']}/2022\n"
                                          ...
                                          f"temperatura máxima: {conteudo['results']['forecast'][6]['min']}°C\n"
                                          f"temperatura mínima: {conteudo['results']['forecast'][6]['max']}°C\n"
...
def dia_7(event):
    texto_resposta_1 = Label(janela, text=f"dia: {conteudo['results']['forecast'][7]['date']}/2022\n"
                                          ...
                                          f"temperatura máxima: {conteudo['results']['forecast'][7]['min']}°C\n"
                                          f"temperatura mínima: {conteudo['results']['forecast'][7]['max']}°C\n"
...
def dia_8(event):
    texto_resposta_1 = Label(janela, text=f"dia: {conteudo['results']['forecast'][8]['date']}/2022\n"
                                          ...
                                          f"temperatura máxima: {conteudo['results']['forecast'][8]['min']}°C\n"
                                          f"temperatura mínima: {conteudo['results']['forecast'][8]['max']}°C\n"
